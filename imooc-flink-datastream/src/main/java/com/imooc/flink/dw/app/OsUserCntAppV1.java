...
public class OsUserCntAppV1 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<Tuple3<String, String, Integer>> result = source.map(new MapFunction<String, Access>() {
            @Override
    ...
    static class RedisExampleMapper implements RedisMapper<Tuple3<String, String, Integer>> {
        ...
        public RedisCommandDescription getCommandDescription() {
           return new RedisCommandDescription(RedisCommand.HSET, "os_user-cnt");
        }
